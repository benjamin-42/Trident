...
t_target_environment info_to_target_environment(const char *device_model, const char *system_version) {
    ...
    determineTarget("iPad2,5", "9.3.0", iPad25_iOS930);
...
//    determineTarget("iPad2,6", "9.3.0", iPad26_iOS930);
...
uint32_t find_OSSerializer_serialize(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS910: return 0x319450;
        case iPad25_iOS920: return 0x3106fc;
        case iPad25_iOS921: return 0x3107fc;
        case iPad25_iOS930: return 0x31812c;
        case iPad25_iOS931: return 0x31812c;
        case iPad25_iOS932: return 0x318264;
        case iPad25_iOS933: return 0x318388;
        case iPad25_iOS934: return 0x318388;
//        case iPad26_iOS910: return 0x319450;
//        case iPad26_iOS920: return 0x3106fc;
//        case iPad26_iOS921: return 0x3107fc;
//        case iPad26_iOS930: return 0x31812c;
//        case iPad26_iOS931: return 0x31812c;
//        case iPad26_iOS932: return 0x318264;
//        case iPad26_iOS933: return 0x318388;
//        case iPad26_iOS934: return 0x318388;
//        case iPad27_iOS910: return 0x319450;
//        case iPad27_iOS920: return 0x3106fc;
//        case iPad27_iOS921: return 0x3107fc;
//        case iPad27_iOS930: return 0x31812c;
//        case iPad27_iOS931: return 0x31812c;
//        case iPad27_iOS932: return 0x318264;
//        case iPad27_iOS933: return 0x318388;
//        case iPad27_iOS934: return 0x318388;
...
uint32_t find_OSSymbol_getMetaClass(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS910: return 0x31bc3c;
        case iPad25_iOS920: return 0x312e18;
        case iPad25_iOS921: return 0x312f18;
        case iPad25_iOS930: return 0x31a934;
        case iPad25_iOS931: return 0x31a934;
        case iPad25_iOS932: return 0x31aa6c;
        case iPad25_iOS933: return 0x31ab90;
        case iPad25_iOS934: return 0x31ab90;
//        case iPad26_iOS910: return 0x31bc3c;
//        case iPad26_iOS920: return 0x312e18;
//        case iPad26_iOS921: return 0x312f18;
//        case iPad26_iOS930: return 0x31a934;
//        case iPad26_iOS931: return 0x31a934;
//        case iPad26_iOS932: return 0x31aa6c;
//        case iPad26_iOS933: return 0x31ab90;
//        case iPad26_iOS934: return 0x31ab90;
//        case iPad27_iOS910: return 0x31bc3c;
//        case iPad27_iOS920: return 0x312e18;
//        case iPad27_iOS921: return 0x312f18;
//        case iPad27_iOS930: return 0x31a934;
//        case iPad27_iOS931: return 0x31a934;
//        case iPad27_iOS932: return 0x31aa6c;
//        case iPad27_iOS933: return 0x31ab90;
//        case iPad27_iOS934: return 0x31ab90;
...
uint32_t find_calend_gettime(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0x1e170;
...
uint32_t find_bufattr_cpx(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0xd9848;
...
uint32_t find_clock_ops(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0x403428;
...
uint32_t find_copyin(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0xc76b4;
...
uint32_t find_bx_lr(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0xd984a;
...
uint32_t find_write_gadget(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0xc73e8;
...
uint32_t find_vm_kernel_addrperm(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0x455844;
...
uint32_t find_kernel_pmap(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0x3f6454;
...
uint32_t find_invalidate_tlb(void) {
    switch (target_environment) {
        ...
        case iPad25_iOS932: return 0xc7440;
