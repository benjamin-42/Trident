...
t_target_environment info_to_target_environment(const char *device_model, const char *system_version) {
	...
	determineTarget("iPad2,4", "9.2", iPad23_iOS920);
	determineTarget("iPad2,4", "9.2.1", iPad23_iOS921);
	determineTarget("iPad2,4", "9.3.0", iPad23_iOS930);
	determineTarget("iPad2,4", "9.3.1", iPad23_iOS931);
	determineTarget("iPad2,4", "9.3.2", iPad23_iOS920);
	determineTarget("iPad2,4", "9.3.3", iPad23_iOS933);
	determineTarget("iPad2,4", "9.3.4", iPad23_iOS934);
